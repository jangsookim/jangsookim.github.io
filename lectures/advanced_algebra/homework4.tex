...
\begin{center}
  \includegraphics[scale=.2]{./figures/image34.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.15]{./figures/image35.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image36.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image37.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image38.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image39.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image40.png}
  \includegraphics[scale=.2]{./figures/image41.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image42.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image44.png}
\end{center}
\end{proof}
...
\begin{proof}[Solution]\
\begin{center}
  \includegraphics[scale=.2]{./figures/image43.png}
\end{center}
\end{proof}
