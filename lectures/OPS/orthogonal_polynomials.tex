...
\item[Case 2] At least one of the regions \( 1,2,3,4 \) is nonempty.
  Let \( m \) be the smallest integer in \( (B\cap C) \setminus A \).
  If \( m \) is in region \( 1 \) (respectively 2, 3, 4), then move
