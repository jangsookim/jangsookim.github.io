...
5. Close Emacs and run it again. The above Newbiemacs main screen will be shown.
...
6. Close Emacs and run it again. The above Newbiemacs main screen will be shown.
...
2. Install Sumatra PDF. [[https://www.sumatrapdfreader.org/free-pdf-reader][Click here]] (Download "Installer", not "Portable version".)
