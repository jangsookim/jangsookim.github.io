...
6. If your local repository is not upto date, you need to do the following.
   ...
   4. If there are conflicts, Git will automatically write them in each conflicted file, which you need to resolve as follows.
      ...
      4. Go back to magit and stage the conflicted file that have been resolved.
