...
- By default your Newbiemacs folder will be ~~/newbiemacs~ (~~~ means
  your home folder.)
- To open the Newbiemacs home folder, go to the Newbiemacs screen and click the folder icon at the top.
- Newbiemacs provides three editing styles, [[https://en.wikipedia.org/wiki/Vim_(text_editor)][Vim]], Emacs, and Windows (default). To change the editing style, type ~x~ and then ~e~ in the Newbiemacs screen.
...
1. Go to the Newbiemacs main screen.
...
|    3 | hojoon  |  472500 |    15 | 2026/01/21 |
|    4 | jangsoo |  432300 |    15 | 2025/12/24 |
|    5 | U-keun  |  382200 |    13 | 2023/02/21 |
