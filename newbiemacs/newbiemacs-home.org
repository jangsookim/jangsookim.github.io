...
2. Install [[https://www.google.com/chrome/][Google Chrome]].
3. Open a terminal and enter the following lines. (You can open a
   terminal by pressing Command+Space and typing "terminal". You can
   just copy the whole thing and then paste it in your terminal.)
   : cd ~
...
4. Run Emacs. It will take several minutes to download necessary
   ...
   When it's done, there will be a message at the bottom saying
   "For information about GNU Emacs and the GNU system, type C-h C-a."
5. If there is an error, install "org-roam" manually by typing "M-x",
   "package-install RET" and then "org-roam RET". Here "M-x" means
   holding the alt key and pressing "x".
6. Close Emacs and run it again. The Newbiemacs main screen will be shown.
...
|    2 | U-keun  | 276000 |    11 | 2022/12/29 |
|    3 | jangsoo | 220200 |    10 | 2022/12/12 |
