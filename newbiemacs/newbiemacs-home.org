...
3. Install [[https://www.gnu.org/software/emacs/][Emacs]] by entering the following in a terminal.
   : brew install --cask emacs
4. Install [[https://git-scm.com/book/en/v2/Getting-Started-Installing-Git][Git]]  by entering the following in a terminal.
   : git --version
5. Open a terminal and enter the following lines. (You can open a
...
6. Run Emacs. It will take several minutes to download necessary
   packages. There may be some warnings but it's okay.
   When it's done, there will be a message at the bottom saying
   "For information about GNU Emacs and the GNU system, type C-h C-a."
7. Close Emacs and run it again. The Newbiemacs main screen will be shown.
...
4. Select Emacs in the drop-down box for ~Preset~.
   ...
   - Select "Preset: custom" and enter ~/opt/homebrew/bin/emacsclient~.
...
6. On macOS, a symlink will be created in this way and you are done.
