...
* Installation
** macOS
1. Install [[https://www.gnu.org/software/emacs/][Emacs]] version 28.2. Click [[https://emacsformacosx.com/emacs-builds/Emacs-28.2-universal.dmg][here]] to download an installation file.
2. Install [[https://git-scm.com/book/en/v2/Getting-Started-Installing-Git][Git]].  Click [[https://github.com/git-for-windows/git/releases/download/v2.42.0.windows.2/Git-2.42.0.2-64-bit.exe][here]] to download an installation file.
...
** Windows
1. Install [[https://www.gnu.org/software/emacs/][Emacs]] version 28.2. Click [[https://ftp.gnu.org/gnu/emacs/windows/emacs-28/emacs-28.2-installer.exe][here]] to download an installation file.
