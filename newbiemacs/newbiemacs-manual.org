...
2. Click "Google Scholar" on the right box.
3. In the Google Scholar page, click "cite".
4. Click "BibTeX" and copy the contents.
5. In a latex file, type ~, n b~ and follow the instructions.
