...
2. Copy the two lines of the title and the authors like this:
   [[file:files/arxiv.png][file:~/Dropbox/newbiemacs/html/my-homepage/newbiemacs/files/arxiv.png]]
...
3. Search the paper there. You will see something like this
   [[file:files/mathscinet.png][file:~/Dropbox/newbiemacs/html/my-homepage/newbiemacs/files/mathscinet.png]]
4. Click the drop-down box at the top left corner and select bibtex.
   [[file:files/mathscinet2.png][file:~/Dropbox/newbiemacs/html/my-homepage/newbiemacs/files/mathscinet2.png]]
5. Copy the bibtex item.
   [[file:files/mathscinet3.png][file:~/Dropbox/newbiemacs/html/my-homepage/newbiemacs/files/mathscinet3.png]] 
