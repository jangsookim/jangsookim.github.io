...
2. Type ~m~ and follow the instructions at the bottom of Emacs screen.
3. It will save a pdf with name scheme such as "Author 1, Authur 2, Title".
4. Now you can search the pdf by typing ~p~ in on the Newbiemacs main screen.
...
1. Click the drop-down box at the top left corner and select bibtex.
#+ATTR_HTML: 
[[./files/mathscinet2.png]]
1. Copy the bibtex item.
#+ATTR_HTML: 
[[./files/mathscient3.png]]
1. Go to your Emacs with the Newbiemacs main screen.
2. Type ~m~ and follow the instructions at the bottom of Emacs screen.
3. It will save a pdf with name scheme such as "Author 1, Authur 2, Year, Title".
4. Now you can search the pdf by typing ~p~ in on the Newbiemacs main screen.
